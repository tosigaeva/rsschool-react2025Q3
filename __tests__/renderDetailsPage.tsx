...
import { DetailsPage } from 'src/pages/details-page/DetailsPage';
import type { CharacterDetails } from 'src/types';
import * as useClient from 'src/shared/api/useClient';
